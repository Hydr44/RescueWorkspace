...
INSERT INTO rentri_registri (
  org_id, user_id, anno, tipo, numero_registro, 
  attivita, descrizione, stato, created_at
) VALUES (
  get_first_org_id(),
  get_first_user_id(),
  2025,
  'carico_scarico',
  'TEST-CS-PROD-2025',
  ARRAY['Produzione']::text[],
  'Registro test Carico/Scarico per attività di Produzione',
  'attivo',
  NOW()
);
...
INSERT INTO rentri_registri (
  ...
  'TEST-CS-RECUP-2025',
  ARRAY['Recupero']::text[],
  'Registro test Carico/Scarico per attività di Recupero',
  'attivo',
  NOW()
);
...
INSERT INTO rentri_registri (
  ...
  'carico_scarico',
  'TEST-CS-SMALT-2025',
  ARRAY['Smaltimento']::text[],
  'Registro test Carico/Scarico per attività di Smaltimento',
  'attivo',
  NOW()
);
...
INSERT INTO rentri_registri (
  ...
  'carico_scarico',
  'TEST-CS-TRASP-2025',
  ARRAY['Trasporto']::text[],
  'Registro test Carico/Scarico per attività di Trasporto',
  'attivo',
  NOW()
);
...
INSERT INTO rentri_registri (
  ...
  'carico_scarico',
  'TEST-CS-CENTRO-2025',
  ARRAY['CentroRaccolta']::text[],
  'Registro test Carico/Scarico per Centro di Raccolta',
  'attivo',
  NOW()
);
...
INSERT INTO rentri_registri (
  ...
  'carico_scarico',
  'TEST-CS-INTERM-2025',
  ARRAY['Intermediazione']::text[],
  'Registro test Carico/Scarico per Intermediazione',
  'attivo',
  NOW()
);
...
INSERT INTO rentri_registri (
  ...
  'carico_scarico',
  'TEST-CS-MULTI-2025',
  ARRAY['Produzione', 'Recupero', 'Trasporto']::text[],
  'Registro test Carico/Scarico multi-attività',
  'attivo',
  NOW()
);
...
INSERT INTO rentri_movimenti (
  ...
  caratteristiche_pericolo, annotazioni, stato, created_at
) VALUES (
  get_first_org_id(),
  get_first_user_id(),
