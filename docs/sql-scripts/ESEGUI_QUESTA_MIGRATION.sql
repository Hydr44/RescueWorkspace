-- ==========================================
-- 🚀 MIGRATION CONFORMITÀ RENTRI 100%
-- ==========================================
-- Data: 2025-12-04
-- Descrizione: Aggiunge conducente, attivita, provenienza
-- 
-- ISTRUZIONI:
-- 1. Vai su Supabase Dashboard → SQL Editor
-- 2. Copia TUTTO questo file
-- 3. Incolla e clicca "Run"
-- 4. Attendi conferma "Success"
-- ==========================================
...
WHERE table_name = 'rentri_formulari'
  AND column_name IN ('conducente_nome', 'conducente_cognome', 'destinatario_attivita', 'rifiuto_provenienza')
...
-- Se vedi 4 righe nel risultato, la migration è andata a buon fine! ✅
