...
<a
href="https://stoplight.io/?utm_source=elements&amp;utm_medium=anagrafiche&amp;utm_campaign=powered_by&amp;utm_content=/paths/soggetto-delegato-num_iscr_ass--registri/get"
...
title="https://api.rentri.gov.it/anagrafiche/v1.0/soggetto-delegato/{num_iscr_ass}/registri">
...
style="unicode-bidi: bidi-override;">https://api.rentri.gov.it/anagrafiche/v1.0</span><span class="sl-flex-1 sl-font-semibold">/soggetto-delegato/{num_iscr_ass}/registri</span>
...
Ottiene l'elenco dei registri gestiti da un soggetto delegato, filtrati
...
## <a href="#/paths/soggetto-delegato-num_iscr_ass--registri/get#Request"
...
### <a
href="#/paths/soggetto-delegato-num_iscr_ass--registri/get#Path-Parameters"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-48-1">
...
<div class="sl-text-sm" level="0">

<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="fc7d515b78969" test="schema-row">
...
test="property-name-num_iscr_ass">
...
<div class="sl-flex-1 sl-h-px sl-mx-3">

</div>

<span class="sl-ml-2 sl-text-warning"
test="property-required">required</span>
...
Numero iscrizione soggetto delegato rilasciato all'iscrizione. Per
recuperare i numeri iscrizione attribuito ai soggetti delegati è
possibile utilizzare /anagrafiche/v1.0/soggetto-delegato.
...
### <a
href="#/paths/soggetto-delegato-num_iscr_ass--registri/get#Query-Parameters"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-49-1">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="7dca8bc748461" test="schema-row">
...
<span class="sl-truncate sl-text-muted"
test="property-type">boolean</span>
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="7bb2691741e29" test="schema-row">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="d0cffc31f7442" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-identificativo_operatore">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="3cb0e909d5255" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-num_iscr_sito">
...
Numero iscrizione unità locale rilasciato all'iscrizione da ricercare.
Per recuperare i numeri di iscrizione attribuiti alle unità locali è
possibile utilizzare
/anagrafiche/v1.0/soggetto-delegato/{num_iscr_ass}/siti.
...
### <a
href="#/paths/soggetto-delegato-num_iscr_ass--registri/get#request-headers"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-50-1">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="4f980827e5ef0" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-Paging-Page">
...
<span class="sl-truncate sl-text-muted"
test="property-type">integer\<int32\></span>
...
Valore per l'header Paging-Page.

</div>

<div class="sl-stack sl-stack--horizontal sl-stack--1 sl-flex sl-flex-row sl-items-center sl-max-w-full sl-text-muted"
...
<span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">1</span>
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="d50d8274c756a" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-Paging-PageSize">
...
Valore per l'header Paging-PageSize.
...
<span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">\>=
1</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">\<=
1000</span>
...
<span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">100</span>
...
## <a href="#/paths/soggetto-delegato-num_iscr_ass--registri/get#Responses"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="react-aria-50-322-tab-200"
...
aria-controls="react-aria-50-322-tabpanel-200" role="tab">

200

</div>

<div id="react-aria-50-322-tab-403"
...
tabindex="-1" key="403" aria-selected="false" role="tab">

403

</div>

<div id="react-aria-50-322-tab-404"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
tabindex="-1" key="404" aria-selected="false" role="tab">

404

</div>

<div id="react-aria-50-322-tab-423"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-50-322-tab-429"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-50-322-tab-500"
...
aria-labelledby="react-aria-50-322-tab-200" role="tabpanel">
...
### <a
href="#/paths/soggetto-delegato-num_iscr_ass--registri/get#response-headers"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-51-1">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="ce5910d2037d1" test="schema-row">
...
<span class="sl-truncate sl-text-muted"
test="property-type">integer</span>
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="72d1c658dcba8" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-Paging-PageCount">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="2cab33a24ba8a" test="schema-row">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="28cd00feaf011" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-Paging-TotalRecordCount">
...
### <a
href="#/paths/soggetto-delegato-num_iscr_ass--registri/get#response-body"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-52-1">
...
data-id="b5aea2ba5f6f9" test="schema-row">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="1eaf8a684bf2c" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-descrizione">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="f7752a2d4a3f6" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-data_creazione">
...
<span class="sl-truncate sl-text-muted"
test="property-type">string\<date-time\></span>
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="054d5990549e0" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-data_chiusura">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="92cdbba9442e6" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-data_modifica">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="af7c4b7dd4d3a" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-num_iscr_associazione">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="a470ef31744ad" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-identificativo_associazione">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="1e6ceae7cb8bd" test="schema-row">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="4534f2b945272" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-identificativo_operatore_sito">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="c8c52cf1a6737" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-operatore_sito">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="b343329f03bd9" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-ipa_operatore_sito">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="e61a640f34e4b" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-cu_aoo_sito">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="d902cfff86670" test="schema-row">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="4f762155584c4" test="schema-row">
...
<span class="sl-truncate sl-text-muted"
test="property-type">array\[string\]</span><span class="sl-text-muted">
or </span><span class="sl-truncate sl-text-muted"
test="property-type">null</span>
...
- *CentroRaccolta* - Centro di raccolta
- *Produzione* - Produzione di rifiuti
- *Recupero* - Recupero di rifiuti
- *Smaltimento* - Smaltimento di rifiuti
- *Trasporto* - Trasporto di rifiuti
- *IntermediazioneSenzaDetenzione* - Intermediazione e commercio di
...
<span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">CentroRaccolta</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">Produzione</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">Recupero</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">Smaltimento</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">Trasporto</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">IntermediazioneSenzaDetenzione</span>
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="efb58c49178f5" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-attivita_rec_smalt">
...
<span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R1</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R2</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R3</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R4</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R5</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R6</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R7</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R8</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R9</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R10</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R11</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R12</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">R13</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D1</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D2</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D3</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D4</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D5</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D6</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D7</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D8</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D9</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D10</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D11</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D12</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D13</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D14</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">D15</span>
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="b964dbac1cd39" test="schema-row">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="1f3d7afbbf432" test="schema-row">
...
<span class="sl-truncate sl-text-muted"
test="property-type">boolean</span><span class="sl-text-muted"> or
</span><span class="sl-truncate sl-text-muted"
test="property-type">null</span>
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="c507b28d3b738" test="schema-row">
...
<div class="sl-font-mono sl-font-semibold sl-mr-2"
test="property-name-progressivo_inziale_locale">
...
``` sl-code-viewer
curl --request GET \  --url https://api.rentri.gov.it/anagrafiche/v1.0/soggetto-delegato/{num_iscr_ass}/registri \  --header 'Accept: application/json, application/problem+json' \  --header 'Authorization: Bearer 123' \  --header 'Paging-Page: ' \  --header 'Paging-PageSize: '
```
...
``` sl-code-viewer
1[2  {3    "identificativo": "string",4    "descrizione": "string",5    "data_creazione": "2019-08-24T14:15:22Z",6    "data_chiusura": "2019-08-24T14:15:22Z",7    "data_modifica": "2019-08-24T14:15:22Z",8    "num_iscr_associazione": "string",9    "identificativo_associazione": "string",10    "num_iscr_sito": "string",11    "identificativo_operatore_sito": "string",12    "operatore_sito": "string",13    "ipa_operatore_sito": "string",14    "cu_aoo_sito": "string",15    "cuu_sito": "string",16    "attivita": [17      "CentroRaccolta"18    ],19    "attivita_rec_smalt": [20      "R1"21    ],22    "stato": "Attivo",23    "uso_locale": true,24    "progressivo_inziale_locale": 025  }26]
```
