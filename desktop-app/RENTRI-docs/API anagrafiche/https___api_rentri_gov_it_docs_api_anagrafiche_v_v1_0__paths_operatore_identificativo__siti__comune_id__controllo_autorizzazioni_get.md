...
<a
href="https://stoplight.io/?utm_source=elements&amp;utm_medium=anagrafiche&amp;utm_campaign=powered_by&amp;utm_content=/paths/operatore-identificativo--siti--comune_id--controllo-autorizzazioni/get"
...
title="https://api.rentri.gov.it/anagrafiche/v1.0/operatore/{identificativo}/siti/{comune_id}/controllo-autorizzazioni">
...
style="unicode-bidi: bidi-override;">https://api.rentri.gov.it/anagrafiche/v1.0</span><span class="sl-flex-1 sl-font-semibold">/operatore/{identificativo}/siti/{comune_id}/controllo-autorizzazioni</span>
...
Restituisce se un operatore, identificato dal codice fiscale, è
autorizzato oppure no, relativamente alle unità locali di un comune,
secondo quanto comunicato dall'operatore al momento dell’iscrizione al
RENTRI.
...
## <a
href="#/paths/operatore-identificativo--siti--comune_id--controllo-autorizzazioni/get#Request"
...
### <a
href="#/paths/operatore-identificativo--siti--comune_id--controllo-autorizzazioni/get#Path-Parameters"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-8-1">
...
data-id="33c77d512c843" test="schema-row">
...
ISTAT comune dell'unità locale
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="567825532a934" test="schema-row">
...
### <a
href="#/paths/operatore-identificativo--siti--comune_id--controllo-autorizzazioni/get#Query-Parameters"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-9-1">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="db212ca70698e" test="schema-row">
...
## <a
href="#/paths/operatore-identificativo--siti--comune_id--controllo-autorizzazioni/get#Responses"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="react-aria-9-56-tab-200"
...
aria-controls="react-aria-9-56-tabpanel-200" role="tab">

200

</div>

<div id="react-aria-9-56-tab-423"
...
<div id="react-aria-9-56-tab-429"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-9-56-tab-500"
...
aria-labelledby="react-aria-9-56-tab-200" role="tabpanel">
...
True se esistono autorizzazioni, false altrimenti
...
### <a
href="#/paths/operatore-identificativo--siti--comune_id--controllo-autorizzazioni/get#response-body"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-10-1">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="a1f73dd864d03" test="schema-row">
...
``` sl-code-viewer
curl --request GET \  --url https://api.rentri.gov.it/anagrafiche/v1.0/operatore/{identificativo}/siti/{comune_id}/controllo-autorizzazioni \  --header 'Accept: application/json, application/problem+json' \  --header 'Authorization: Bearer 123'
```
