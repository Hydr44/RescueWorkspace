...
<a
href="https://stoplight.io/?utm_source=elements&amp;utm_medium=anagrafiche&amp;utm_campaign=powered_by&amp;utm_content=/paths/operatore-identificativo--controllo-iscrizione/get"
...
title="https://api.rentri.gov.it/anagrafiche/v1.0/operatore/{identificativo}/controllo-iscrizione">
...
style="unicode-bidi: bidi-override;">https://api.rentri.gov.it/anagrafiche/v1.0</span><span class="sl-flex-1 sl-font-semibold">/operatore/{identificativo}/controllo-iscrizione</span>
...
Restituisce se un operatore, identificato dal codice fiscale, è iscritto
o no al RENTRI
...
## <a
href="#/paths/operatore-identificativo--controllo-iscrizione/get#Request"
...
### <a
href="#/paths/operatore-identificativo--controllo-iscrizione/get#Path-Parameters"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-6-1">
...
data-id="13397896d508b" test="schema-row">
...
## <a
href="#/paths/operatore-identificativo--controllo-iscrizione/get#Responses"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="react-aria-6-42-tab-200"
...
aria-controls="react-aria-6-42-tabpanel-200" role="tab">

200

</div>

<div id="react-aria-6-42-tab-423"
...
<div id="react-aria-6-42-tab-429"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-6-42-tab-500"
...
aria-labelledby="react-aria-6-42-tab-200" role="tabpanel">
...
True se l'operatore con il codice fiscale indicato risulta iscritto,
false altrimenti
...
### <a
href="#/paths/operatore-identificativo--controllo-iscrizione/get#response-body"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-7-1">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="1da7791fc66e6" test="schema-row">
...
``` sl-code-viewer
curl --request GET \  --url https://api.rentri.gov.it/anagrafiche/v1.0/operatore/{identificativo}/controllo-iscrizione \  --header 'Accept: application/json, application/problem+json' \  --header 'Authorization: Bearer 123'
```
