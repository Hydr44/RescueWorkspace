...
<a
href="https://stoplight.io/?utm_source=elements&amp;utm_medium=anagrafiche&amp;utm_campaign=powered_by&amp;utm_content=/paths/registri-identificativo--xml/get"
...
title="https://api.rentri.gov.it/anagrafiche/v1.0/registri/{identificativo}/xml">
...
style="unicode-bidi: bidi-override;">https://api.rentri.gov.it/anagrafiche/v1.0</span><span class="sl-flex-1 sl-font-semibold">/registri/{identificativo}/xml</span>
...
Rif. MODALITÀ OPERATIVA (8): Vidimazione digitale del registro
cronologico di carico e scarico.

Nella fase di creazione di un nuovo registro, la piattaforma telematica
RENTRI accede al servizio per la vidimazione digitale messo a
disposizione dalle Camere di Commercio e restituisce l'identificativo
unico nazionale del registro cronologico di carico e scarico.
...
## <a href="#/paths/registri-identificativo--xml/get#Request"
...
### <a href="#/paths/registri-identificativo--xml/get#Path-Parameters"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-45-1">
...
data-id="d47d6514bd1a0" test="schema-row">
...
## <a href="#/paths/registri-identificativo--xml/get#Responses"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="react-aria-45-288-tab-200"
...
aria-controls="react-aria-45-288-tabpanel-200" role="tab">

200

</div>

<div id="react-aria-45-288-tab-403"
...
<div id="react-aria-45-288-tab-404"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-45-288-tab-423"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-45-288-tab-429"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-45-288-tab-500"
...
aria-labelledby="react-aria-45-288-tab-200" role="tabpanel">
...
Nel campo "content" viene restituito il file XML firmato digitalmente
nel formato Base64, che risponde alla definizione del "element = eREGI"
definito nello schema XSD consultabile nella sezione "Risorse \> Schemi
di validazione XSD" nel file “rentri-registri-1.0.xsd”.
...
### <a href="#/paths/registri-identificativo--xml/get#response-body"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-46-1">
...
data-id="69a02088d1b06" test="schema-row">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="bbf0d5b3331bb" test="schema-row">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="0b00df033c3b2" test="schema-row">
...
<span class="sl-truncate sl-text-muted"
test="property-type">string\<byte\></span><span class="sl-text-muted">
...
``` sl-code-viewer
curl --request GET \  --url https://api.rentri.gov.it/anagrafiche/v1.0/registri/{identificativo}/xml \  --header 'Accept: application/json, application/problem+json' \  --header 'Authorization: Bearer 123'
```
...
``` sl-code-viewer
1{2  "nome_file": "string",3  "mime": "string",4  "content": "string"5}
```
