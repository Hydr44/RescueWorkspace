...
<a
href="https://stoplight.io/?utm_source=elements&amp;utm_medium=anagrafiche&amp;utm_campaign=powered_by&amp;utm_content=/paths/operatore-identificativo--controllo-autorizzazione-albo/get"
...
title="https://api.rentri.gov.it/anagrafiche/v1.0/operatore/{identificativo}/controllo-autorizzazione-albo">
...
style="unicode-bidi: bidi-override;">https://api.rentri.gov.it/anagrafiche/v1.0</span><span class="sl-flex-1 sl-font-semibold">/operatore/{identificativo}/controllo-autorizzazione-albo</span>
...
autorizzato oppure no all'Albo Nazionale Gestori Ambientali secondo
quanto comunicato dall'operatore al momento dell’iscrizione al RENTRI.
...
## <a
href="#/paths/operatore-identificativo--controllo-autorizzazione-albo/get#Request"
...
### <a
href="#/paths/operatore-identificativo--controllo-autorizzazione-albo/get#Path-Parameters"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-4-1">
...
data-id="c01cbe3dcb745" test="schema-row">
...
## <a
href="#/paths/operatore-identificativo--controllo-autorizzazione-albo/get#Responses"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="react-aria-4-30-tab-200"
...
aria-controls="react-aria-4-30-tabpanel-200" role="tab">

200

</div>

<div id="react-aria-4-30-tab-423"
...
<div id="react-aria-4-30-tab-429"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-4-30-tab-500"
...
aria-labelledby="react-aria-4-30-tab-200" role="tabpanel">
...
### <a
href="#/paths/operatore-identificativo--controllo-autorizzazione-albo/get#response-body"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-5-1">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2"
data-id="8592cc21ed31a" test="schema-row">
...
``` sl-code-viewer
curl --request GET \  --url https://api.rentri.gov.it/anagrafiche/v1.0/operatore/{identificativo}/controllo-autorizzazione-albo \  --header 'Accept: application/json, application/problem+json' \  --header 'Authorization: Bearer 123'
```
