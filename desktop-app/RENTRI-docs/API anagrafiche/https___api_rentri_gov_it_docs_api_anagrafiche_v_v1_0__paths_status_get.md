...
<a
href="https://stoplight.io/?utm_source=elements&amp;utm_medium=anagrafiche&amp;utm_campaign=powered_by&amp;utm_content=/paths/status/get"
...
title="https://api.rentri.gov.it/anagrafiche/v1.0/status">
...
style="unicode-bidi: bidi-override;">https://api.rentri.gov.it/anagrafiche/v1.0</span><span class="sl-flex-1 sl-font-semibold">/status</span>
...
## <a href="#/paths/status/get#Request"
...
## <a href="#/paths/status/get#Responses"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
aria-controls="react-aria-0-6-tabpanel-200" role="tab">

200

</div>

<div id="react-aria-0-6-tab-423"
...
<div id="react-aria-0-6-tab-503"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-danger-tint sl-text-danger hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
tabindex="-1" key="503" aria-selected="false" role="tab">
...
aria-labelledby="react-aria-0-6-tab-200" role="tabpanel">
...
### <a href="#/paths/status/get#response-body"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-1-1">
...
data-id="f9c068a43e144" test="schema-row">
...
- *Ok* - API regolarmente funzionante
- *Warning* - API funzionante, ma con probabili disservizi come indicato
  nei warning
...
<span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">Ok</span><span class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">Warning</span>
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="e92fa3902db74" test="schema-row">
...
``` sl-code-viewer
curl --request GET \  --url https://api.rentri.gov.it/anagrafiche/v1.0/status \  --header 'Accept: application/json, application/problem+json' \  --header 'Authorization: Bearer 123'
```
...
``` sl-code-viewer
1{2  "status": "Ok",3  "warnings": [4    "string"5  ]6}
```
