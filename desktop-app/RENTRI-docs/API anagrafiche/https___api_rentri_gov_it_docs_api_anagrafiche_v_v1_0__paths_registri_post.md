...
<a
href="https://stoplight.io/?utm_source=elements&amp;utm_medium=anagrafiche&amp;utm_campaign=powered_by&amp;utm_content=/paths/registri/post"
...
title="https://api.rentri.gov.it/anagrafiche/v1.0/registri">

<div class="sl-text-lg sl-font-semibold sl-uppercase sl-px-2.5 sl-py-1 sl-bg-primary sl-text-on-primary sl-rounded-lg">
...
style="unicode-bidi: bidi-override;">https://api.rentri.gov.it/anagrafiche/v1.0</span><span class="sl-flex-1 sl-font-semibold">/registri</span>
...
## <a href="#/paths/registri/post#Request"
...
### <a href="#/paths/registri/post#request-body"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-37-1">
...
data-id="c36ae7187a9d6" test="schema-row">
...
<span class="sl-mr-1">Numero iscrizione unità locale rilasciato
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="1f64b2473e5e8" test="schema-row">
...
<span class="sl-mr-1">Attività legate al
registro.</span><span class="sl-link sl-cursor-pointer">Show
all...</span>
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="d144cc87ff89d" test="schema-row">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="ea4753e4b062b" test="schema-row">
...
<span class="sl-mr-1">Attività recupero
smaltimento.</span><span class="sl-link sl-cursor-pointer">Show
all...</span>
...
## <a href="#/paths/registri/post#Responses"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="react-aria-37-235-tab-201"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 sl-bg-success sl-text-on-primary sl-rounded-lg sl-border-light sl-cursor"
tabindex="0" key="201" aria-selected="true"
aria-controls="react-aria-37-235-tabpanel-201" role="tab">

201

</div>

<div id="react-aria-37-235-tab-400"
...
tabindex="-1" key="400" aria-selected="false" role="tab">

400

</div>

<div id="react-aria-37-235-tab-403"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-37-235-tab-404"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-37-235-tab-423"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-37-235-tab-429"
class="sl-font-medium sl-p-1 sl-px-2 sl-py-1 hover:sl-bg-warning-tint sl-text-warning hover:sl-text-body sl-rounded-lg sl-border-light sl-cursor-pointer"
...
<div id="react-aria-37-235-tab-500"
...
aria-labelledby="react-aria-37-235-tab-201" role="tabpanel">
...
Identificativo del registro aperto.
...
### <a href="#/paths/registri/post#response-body"
class="sl-link sl-link-heading__link sl-inline-flex sl-items-center sl-text-current"></a>
...
<div id="mosaic-provider-react-aria-38-1">
...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3"
data-id="1cf8114331d9b" test="schema-row">
...
``` sl-code-viewer
curl --request POST \  --url https://api.rentri.gov.it/anagrafiche/v1.0/registri \  --header 'Accept: application/json, application/problem+json' \  --header 'Authorization: Bearer 123' \  --header 'Content-Type: application/json' \  --data '{  "num_iscr_sito": "string",  "attivita": [    "CentroRaccolta"  ],  "descrizione": "string",  "attivita_rec_smalt": [    "R1"  ]}'
```
