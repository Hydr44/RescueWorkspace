...
// Pagina per accettare inviti team via link email
...
export default function AcceptInvite() {
  ...
  const [step, setStep] = useState("loading"); // loading, register, success, error
  ...
  async function handleAccept(e) {
    ...
    try {
      ...
      if (profileError && profileError.code !== "23505") {
        // Ignora errore duplicato (profilo già creato da trigger)
      ...
      if (signInError) {
        ...
        // Non bloccare, l'utente può fare login manualmente
      }
