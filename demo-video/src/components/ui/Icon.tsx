...
/**
 * Icone in stile Feather/Lucide (l'app usa react-icons/fi + qualche Ionicon).
 * Ricreate inline per fedelta' e per non dipendere da pacchetti runtime.
 */
const PATHS: Record<string, string> = {
  ...
  euro: '<path d="M14.5 4.5A6.5 6.5 0 1 0 14.5 19.5"/><line x1="3" y1="10" x2="12" y2="10"/><line x1="3" y1="14" x2="10" y2="14"/>',
  download:
...
// icone che rendono meglio piene
const FILLED = new Set(["navigation2", "star", "play"]);
...
}> = ({ name, size = 24, color = "currentColor", strokeWidth = 2, fill, style }) => {
  const inner = PATHS[name] ?? PATHS.package;
  const resolvedFill = fill ?? (FILLED.has(name) ? color : "none");
  return (
    <svg
      width={size}
      height={size}
